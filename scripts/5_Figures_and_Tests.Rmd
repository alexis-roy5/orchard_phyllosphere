...
arrange(abun.summary, mean_Conventional)
arrange(abun.summary, mean_Organic)
...
ggplot(aes(x = PCo1, y = PCo2, color = highlight, fill = highlight, shape = highlight))+
  geom_point(size=2.5)+
  theme_bw()+
    scale_color_manual(values = c("#E1E1E0","black","black"))+
    scale_shape_manual(values = c(21,21,21))+
    # D1 and D2 will have color and the "other" will be gray
    scale_fill_manual(name = "Sites", values = c("#E1E1E0","#F28E2B", "#499894"))+
    labs(x = paste("PCo1:", 100*eig6[1], "%"),
       y = paste("PCo2:", 100*eig6[2], "%")) +
     #ylim(-2,1.5)+
  #xlim(-1.1,1.25)+
